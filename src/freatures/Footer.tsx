const ModeButtonSwitch = () => (
  <button aria-label="Toggle Dark Mode" role="button">
...
const LanguageSelect = () => (
  <select
    ...
    className="border-grey language-select text-col-grey-dark mt-8 w-56 appearance-none bg-transparent py-2 font-medium xl:mt-0"
    defaultValue="en"
  >
...
const Footer = () => (
  <footer className="w-max-full flex flex-col px-7 pb-16 pt-10 xl:flex-row xl:items-center xl:justify-between xl:px-16 xl:py-10">
    <div className="text-col-grey flex flex-1 flex-col items-start space-y-6 text-base font-medium xl:flex-row xl:items-center xl:space-x-6 xl:space-y-0">
