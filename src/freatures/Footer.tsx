...
const Footer = () => (
  <footer className="w-max-full bg-col-black-1 flex flex-col px-7 pb-16 pt-10 xl:flex-row xl:items-center xl:justify-between xl:px-16 xl:py-10">
    <div className="text-col-grey-3 flex flex-1 flex-col items-start space-y-6 text-base font-medium xl:flex-row xl:items-center xl:space-x-6 xl:space-y-0">
