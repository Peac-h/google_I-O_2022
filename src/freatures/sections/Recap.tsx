const Recap = () => (
  <section className="border-yellow mt-2 flex flex-col rounded-lg bg-col-yellow-light p-6 text-col-dark md:flex-row md:p-10">
    <div className="flex h-full flex-1 flex-col">
      <h2 className="font-h2-large">I/O '22 recap</h2>
      <div className="my-6 text-left text-lg font-medium md:mr-24 md:text-xl lg:mr-32">
    ...
    >
      <iframe
        className="h-56 w-full rounded-lg lg:h-[14.625rem] lg:w-[26rem] xl:h-[20.8125rem] xl:w-[37rem]"
        width="460"
        height="387"
